...
$\shortstack{$T_o$, $T_s$,\\ $hA$}$ & oil/steel temps., conductance & $^\circ$C; W\,K$^{-1}$ & Two-node thermal block. \\
...
hp_cut & 0.05 & \si{Hz} & High-pass filter cutoff. \\
band_fac & [0.8, 1.2] & -- & $T_1$ band factor for IM . \\
band_N & 21 & -- & Periods in band . \\
s_bounds & [0.2, 2.2] & -- & Scale factor bounds . \\
\bottomrule
\end{tabularx}
\end{table}
...
$v_\varepsilon$ & 0.10 & m\,s$^{-1}$ & Sign/flow smoothing. \\
...
$\rho_{\mathrm{ref}}$ & 850 & kg\,m$^{-3}$ & Oil density (ref.). \\
...
$C_o,\,C_s$ & \textit{[derived]} & J\,K$^{-1}$ & Thermal capacitances (from $m_{oil}, c_p$).\\
$hA_{o\leftrightarrow s}$ & 450 & W\,K$^{-1}$ & Oil–steel exchange.\\
