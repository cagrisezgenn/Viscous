...
\begin{table}[htbp]
  ...
  \label{tab:opt-vars}
  \begin{tabularx}{\linewidth}{@{}l>{\raggedright\arraybackslash}X S[table-format=1.5] S[table-format=1.5] >{\raggedright\arraybackslash}X@{}}
  \toprule
...
\IfFileExists{refs.bib}{%
  ...
  Placeholder Author, ``Provide bibliographic entries in \texttt{refs.bib} before submission,'' (2025).
  \end{thebibliography}%
}
