...
ub = [3.0,8, 0.90, 5, 0.90, 1.00, 1.50, 200, 600, 240, 16, 160, 18, 2.00, 3];
 ...
 2.60  5  0.06 1.10 0.60 0.82 1.20  50 250 100 10  60  5 0.90;   % düşük Lori_mm, orta diğerleri
    ...
    T = array2table([X F PFA_mean IDR_mean pen pen_dP pen_Qcap pen_cav pen_T pen_mu ...
        ...
        'VariableNames', {'d_o_mm','n_orf','PF_tau','PF_gain','Cd0','CdInf','p_exp','Lori_mm','hA_W_perK','Dp_mm','d_w_mm','D_m_mm','n_turn','mu_ref','PF_t_on', ...
